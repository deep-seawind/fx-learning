        ...
        >
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
            Master Forex Trading with{" "}
              <span className="inline-block bg-clip-text text-transparent bg-linear-to-r from-blue-500 to-indigo-600 drop-shadow-lg">
              Expert Mentors
            </span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button className="flex items-center gap-2 bg-linear-to-r from-blue-600 to-indigo-700 text-white px-6 sm:px-8 py-3 rounded-full font-semibold shadow-md hover:shadow-xl hover:scale-[1.02] transition">
              Start Learning <ArrowRight size={18} />
            </button>

            <button className="border-2 border-gray-300 text-gray-700 px-6 sm:px-8 py-3 rounded-full font-semibold hover:border-blue-500 hover:text-blue-600 transition">
              Explore Courses
            </button>
          </div>
          ...
          <div
            ref={counterRef}
            className="grid grid-cols-3 sm:text-center text-left gap-6 pt-6 border-t border-gray-200"
          >
            <div>
