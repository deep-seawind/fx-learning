...
export default function HowItWorks() {
  return (
    <section className="py-24 bg-linear-to-b from-white via-[#0082ff0d] to-white">
      <div className="container mx-auto px-6 lg:px-0 text-center">
        ...
        >
          How It{" "}
          <span
            className="bg-clip-text text-transparent bg-linear-to-r from-blue-500 to-indigo-600 block sm:inline ps-3" 
          >
            Works
          </span>
        </motion.h2>
          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-white rounded-3xl p-8 shadow-xl border border-[#0036d620]
                           hover:shadow-2xl hover:-translate-y-2 transition-all group"
              >
                {/* Step Number */}
                <div className="absolute -top-6 left-1/2 -translate-x-1/2">
                  <div
                    className="text-white font-bold w-14 h-14 flex items-center justify-center 
                    rounded-full shadow-lg text-xl group-hover:scale-110 transition-transform"
                    style={{
                      background: "linear-gradient(to right, #0036d6, #0082ff)",
                    }}
                  >
                    {index + 1}
                  </div>
                ...
                <div className="mt-8 mb-6 flex justify-center">
                  ...
                  >
                    <Icon className="w-10 h-10" style={{ color: "#0082ff" }} />
                  </div>
                </div>
